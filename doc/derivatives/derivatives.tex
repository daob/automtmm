...
Some authors have suggested applying the $z$-transform \citep[section 35]{fisher1925statistical} to standardized parameters.
...
\begin{figure}[htbp]
\begin{center}
\caption{Confidence intervals constructed via the Fisher z-transformation.}
