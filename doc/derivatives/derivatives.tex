...
In what follows we formulate our discussion in the framework described, which corresponds to the 
LISREL ``all-y'' framework \citep{joreskog1996lisrel}. Due to the fact the LISREL all-y model is 
equivalent to other SEM frameworks in use by standard software such as the RAM and Bentler-Weeks models 
\citep{mcardle1984some,bentler1980linear},
this formulation does not imply a loss of generality, however.
